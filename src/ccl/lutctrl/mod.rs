...
impl<'a> _INSEL0W<'a> {
    ...
    pub fn alt2tc(self) -> &'a mut W {
        self.variant(INSEL0W::ALT2TC)
    }
    #[doc = "Asynchronous event input source. The EVENT input will bypass edge detection logic."]
    #[inline]
    pub fn asyncevent(self) -> &'a mut W {
        self.variant(INSEL0W::ASYNCEVENT)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl<'a> _INSEL1W<'a> {
    ...
    #[inline]
    pub fn alt2tc(self) -> &'a mut W {
        self.variant(INSEL1W::ALT2TC)
    }
    #[doc = "Asynchronous event input source. The EVENT input will bypass edge detection logic."]
    #[inline]
    pub fn asyncevent(self) -> &'a mut W {
        self.variant(INSEL1W::ASYNCEVENT)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl<'a> _INSEL2W<'a> {
    ...
    #[inline]
    pub fn alt2tc(self) -> &'a mut W {
        self.variant(INSEL2W::ALT2TC)
    }
    #[doc = "Asynchronous event input source. The EVENT input will bypass edge detection logic."]
    #[inline]
    pub fn asyncevent(self) -> &'a mut W {
        self.variant(INSEL2W::ASYNCEVENT)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
