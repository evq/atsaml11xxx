...
impl R {
    ...
    #[inline]
    pub fn stdbypl0(&self) -> STDBYPL0R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 5 - Standby in PL0"]
    #[inline]
    pub fn stdbypl0(&mut self) -> _STDBYPL0W {
        _STDBYPL0W { w: self }
    }
    #[doc = "Bit 6 - Run during Standby"]
    #[inline]
    ...
    #[doc = "Bits 16:19 - Voltage Scaling Voltage Step"]
    #[inline]
    pub fn vsvstep(&mut self) -> _VSVSTEPW {
        _VSVSTEPW { w: self }
    }
    #[doc = "Bits 24:31 - Voltage Scaling Period"]
    #[inline]
