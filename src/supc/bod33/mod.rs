...
impl REFSELR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            REFSELR::SEL_VREFDETREF => false,
            REFSELR::SEL_ULPVREF => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl REFSELW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            REFSELW::SEL_VREFDETREF => false,
            REFSELW::SEL_ULPVREF => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _REFSELW<'a> {
    ...
    pub fn sel_vrefdetref(self) -> &'a mut W {
        self.variant(REFSELW::SEL_VREFDETREF)
    }
    #[doc = "Selects ULPVREF for the BOD33"]
    #[inline]
    pub fn sel_ulpvref(self) -> &'a mut W {
        self.variant(REFSELW::SEL_ULPVREF)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
