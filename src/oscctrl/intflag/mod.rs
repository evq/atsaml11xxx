...
#[doc = r" Proxy"]
pub struct _OSC16MRDYW<'a> {
    w: &'a mut W,
}
impl<'a> _OSC16MRDYW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _DFLLULPRDYW<'a> {
    w: &'a mut W,
}
impl<'a> _DFLLULPRDYW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _DFLLULPLOCKW<'a> {
    w: &'a mut W,
}
impl<'a> _DFLLULPLOCKW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _DFLLULPNOLOCKW<'a> {
    w: &'a mut W,
}
impl<'a> _DFLLULPNOLOCKW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _DPLLLDRTOW<'a> {
    w: &'a mut W,
}
impl<'a> _DPLLLDRTOW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn osc16mrdy(&self) -> OSC16MRDYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn dfllulprdy(&self) -> DFLLULPRDYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn dfllulplock(&self) -> DFLLULPLOCKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn dfllulpnolock(&self) -> DFLLULPNOLOCKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 10;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 4 - OSC16M Ready"]
    #[inline]
    pub fn osc16mrdy(&mut self) -> _OSC16MRDYW {
        _OSC16MRDYW { w: self }
    }
    #[doc = "Bit 8 - DFLLULP Ready"]
    #[inline]
    pub fn dfllulprdy(&mut self) -> _DFLLULPRDYW {
        _DFLLULPRDYW { w: self }
    }
    #[doc = "Bit 9 - DFLLULP Lock"]
    #[inline]
    pub fn dfllulplock(&mut self) -> _DFLLULPLOCKW {
        _DFLLULPLOCKW { w: self }
    }
    #[doc = "Bit 10 - DFLLULP No Lock"]
    #[inline]
    pub fn dfllulpnolock(&mut self) -> _DFLLULPNOLOCKW {
        _DFLLULPNOLOCKW { w: self }
    }
    #[doc = "Bit 16 - DPLL Lock Rise"]
    #[inline]
    ...
    #[doc = "Bit 19 - DPLL Loop Divider Ratio Update Complete"]
    #[inline]
    pub fn dpllldrto(&mut self) -> _DPLLLDRTOW {
        _DPLLLDRTOW { w: self }
    }
}
