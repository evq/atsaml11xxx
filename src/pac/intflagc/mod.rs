...
impl W {
    ...
    #[doc = "Bit 12 - OPAMP"]
    #[inline]
    pub fn opamp_(&mut self) -> _OPAMP_W {
        _OPAMP_W { w: self }
    }
    #[doc = "Bit 13 - TRAM"]
    #[inline]
    pub fn tram_(&mut self) -> _TRAM_W {
        _TRAM_W { w: self }
    }
}
