...
impl MUXNEGR {
    ...
    #[doc = "Checks if the value of the field is `DACOPAMP`"]
    #[inline]
    pub fn is_dacopamp(&self) -> bool {
        *self == MUXNEGR::DACOPAMP
    }
}
...
impl<'a> _MUXNEGW<'a> {
    ...
    #[doc = "DAC output (on AC0) / OPAMP output (on AC1)"]
    #[inline]
    pub fn dacopamp(self) -> &'a mut W {
        self.variant(MUXNEGW::DACOPAMP)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub fn bits(self, value: u8) -> &'a mut W {
...
impl<'a> _SPEEDW<'a> {
    ...
    pub fn medlow(self) -> &'a mut W {
        self.variant(SPEEDW::MEDLOW)
    }
    #[doc = "Medium high speed"]
    #[inline]
    pub fn medhigh(self) -> &'a mut W {
        self.variant(SPEEDW::MEDHIGH)
    }
    #[doc = "High speed"]
    #[inline]
...
impl<'a> _HYSTW<'a> {
    ...
    pub fn hyst70(self) -> &'a mut W {
        self.variant(HYSTW::HYST70)
    }
    #[doc = "90mV"]
    #[inline]
    pub fn hyst90(self) -> &'a mut W {
        self.variant(HYSTW::HYST90)
    }
    #[doc = "110mV"]
    #[inline]
    pub fn hyst110(self) -> &'a mut W {
        self.variant(HYSTW::HYST110)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub fn bits(self, value: u8) -> &'a mut W {
